    ...
    <div id="header">
        ...
        <nav id="nav">
            <ul>
                ...
                <li class="current"><a href="index.php?action=stone.php">Блог Камня</a></li>
        ...
        <div class="container">
            <div class="row">
                <section class="12u 12u(narrower)">
                    <div class="box post">
                        <a href="#" class="image left"><img src="images/stone.jpg" alt="" /></a>
                        <div class="inner">
                            <h3>12.12.2018</h3>
            ...
            <div class="row">
                <section class="12u 12u(narrower)">
                    <div class="box post">
                        ...
                        <div class="inner">
                            <h3>15.10.2016</h3>
                            <p>Сегодня я стал капитаном CTF команды SharLike</p>
                        </div>
                    </div>
                </section>
            </div>
