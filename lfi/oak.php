    ...
    <div id="header">
        ...
        <nav id="nav">
            <ul>
                ...
                <li  class="current"><a href="index.php?action=oak.php">Блог Старого Дуба</a></li>
            </ul>
        </nav>
        ...
        <div class="container">
            <div class="row">
                <section class="12u 12u(narrower)">
                    <div class="box post">
                        <a href="#" class="image left"><img src="images/dub.jpg" alt="" /></a>
                        <div class="inner">
                            <h3>12.12.2018</h3>
                            <p>Сегодня ничего не произошло</p>
                        </div>
                    </div>
                </section>
            </div>
            ...
            <div class="row">
                <section class="12u 12u(narrower)">
                    <div class="box post">
                        ...
                        <div class="inner">
                            <h3>15.10.2016</h3>
                            <p>Сегодня в лес задуло каноплю и жители представляли всякие небылицы.<br> ПЫЩ-ПЫЩ ОЛОЛО, я водитель НЛО</p>
                        </div>
                    </div>
                </section>
            </div>
